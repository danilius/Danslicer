...
Source and validation evidence: `558157446a3d0c2ee7f2e8bdb363dd0a1fb624d1` on `codex/native-printer-writers`. Final Release regression: 1,030 passed; final isolated native UI capture: all ten success markers, no errors. Independent external decode: 18 profiles / 36 exact layer images. Original Mono X output is byte-identical to the baseline. No physical printing was performed. The three unrelated queued-task documents remain untracked and untouched.
