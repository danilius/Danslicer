...
void Usage()
{
    ...
    Console.Error.WriteLine("  danslicer bench [--drogon <path>] [--gripper <path>] [--mini-tip-shape cone|capsule] [--reinforce on|off] [--min-member-separation <mm>] [--output <summary.json>]");
}
